...
public interface UserRepository extends JpaRepository<User, Long>, JpaSpecificationExecutor<User> {
     ...
     */
    @Modifying
    @Query(value = "update eladmin.sys_user set password = ?2 , pwd_reset_time = ?3 where username = ?1",nativeQuery = true)
     ...
     */
    @Modifying
    @Query(value = "update eladmin.sys_user set email = ?2 where username = ?1",nativeQuery = true)
     ...
     * @return /
     */
    @Query(value = "SELECT u.* FROM eladmin.sys_user u, eladmin.sys_users_roles r WHERE" +
     ...
     * @return /
     */
    @Query(value = "SELECT count(1) FROM eladmin.sys_user u, eladmin.sys_users_jobs j WHERE u.user_id = j.user_id AND j.job_id IN ?1", nativeQuery = true)
     ...
     * @return /
     */
    @Query(value = "SELECT count(1) FROM eladmin.sys_user u WHERE u.dept_id IN ?1", nativeQuery = true)
     ...
     * @return /
     */
    @Query(value = "SELECT count(1) FROM eladmin.sys_user u, eladmin.sys_users_roles r WHERE " +
