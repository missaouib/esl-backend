...
public interface MenuRepository extends JpaRepository<Menu, Long>, JpaSpecificationExecutor<Menu> {
     ...
     * @return /
     */
    @Query(value = "SELECT m.* FROM eladmin.sys_menu m, eladmin.sys_roles_menus r WHERE " +
     ...
     */
    @Modifying
    @Query(value = " update eladmin.sys_menu set sub_count = ?1 where menu_id = ?2 ",nativeQuery = true)
